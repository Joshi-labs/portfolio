...
import i_sys from "../assets/img/skills/i-sys.png";
import i_os from "../assets/img/skills/i-os.png";
import i_game from "../assets/img/skills/i-game.png";
import i_web from "../assets/img/skills/i-web.png";
import i_cloud from "../assets/img/skills/i-cloud.png";
import i_ops from "../assets/img/skills/i-ops.png";
import i_aiml from "../assets/img/skills/i-aiml.png";
  ...
  return (
    <section id="skills" className="py-20 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="bg-[#15155] rounded-[0.4rem] md:rounded-[1rem] px-4 py-10 md:px-8 md:py-16 text-center shadow-[0_0_50px_rgba(0,0,0,0.5)] border border-white/5">

...
const allProjects = [
  ...
  { category: "Core", title: "S3 Drive", description: "A self-hosted Google Drive alternative built on AWS S3 and Go.", imgUrl: projImage_s3, visit: "https://s3-drive.vpjoshi.in", docs: "https://docs.vpjoshi.in/#/s3-drive", github: "https://github.com/Joshi-labs/s3-drive" },
